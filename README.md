...
It provides modules for centroid detection, FITS-file analysis, **navigation algorithms**, and photometric testing utilities — useful for **spacecraft autonomy**, exoplanet research, and star tracker applications.
